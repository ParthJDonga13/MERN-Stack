    ...
    <div>
          ...
          <div className='col-md-12'>
            <div className='row'>
              <div className='social'>
                <ul>
                  <li>
                    <a href='https://www.facebook.com/parth.donga.73/' target='blank'>
                      <i className='fa fa-facebook'></i>
                    </a>
                  </li>
                  <li>
                    <a href='https://www.instagram.com/parth_donga13/' target='blank'>
      ...
      <div id='footer'>
        <div className='container text-center'>
          <p>
            &copy; Parth Donga (Student at Conestoga college)
          </p>
        </div>
      </div>
    </div>
